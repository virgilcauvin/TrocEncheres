		...
		<div class="row">
			<div class="col-11 offset-1">
				...
				<div>
					<!-- /!\NEW -->
					<a
						href="${pageContext.request.contextPath}/ServletConnexionCompte?deconnexion">D�connexion</a>
				</div>
				<h2>Filtres :</h2>
				<div>
					...
					<c:forEach var="venteEnCours" items="${listeVentesEnCours}">
	   					<div class="border">
							...
							<p>Retrait : (� faire)</p>
							<span>Vendeur : </span><a href="${pageContext.request.contextPath}/Secure/ServletEnchere">${venteEnCours.noUtilisateur} (� remplacer par pseudo et href � cr�er)</a>
	   					</div>
	   				</c:forEach>
					...
					<c:forEach var="enchereUtilisateurEnCours" items="${listeEncheresUtilisateurEnCours}">
	   					<div class="border">
	   						...
	   						<p>
	   							<span>Prix : ${enchereUtilisateurEnCours.prixVente} points</span><span>classement : (� faire)</span>
	   						</p>
							<p>Fin de l'ench�re : ${enchereUtilisateurEnCours.dateFinEncheres}</p>
							<p>Retrait : </p>
							<span>Vendeur : </span><a href="${pageContext.request.contextPath}/Secure/ServletEnchere">${enchereUtilisateurEnCours.noUtilisateur} (� remplacer par pseudo et href � cr�er)</a>
	   					</div>
	   				</c:forEach>
