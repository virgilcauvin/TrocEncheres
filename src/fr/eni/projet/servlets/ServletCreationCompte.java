...
public class ServletCreationCompte extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		prenom = request.getParameter("prenom").toLowerCase();
		email = request.getParameter("email").toLowerCase();
		telephone = request.getParameter("telephone").toLowerCase();
		rue = request.getParameter("rue").toLowerCase();
		codePostal = request.getParameter("codePostal").toLowerCase();
		ville = request.getParameter("ville").toLowerCase();
		motDePasse = request.getParameter("motDePasse").toLowerCase();
		confirmationMDP = request.getParameter("confirmation").toLowerCase();
		...
		if (listeErreurChamps.size()>0) {
			...
			urlCible = "/WEB-INF/creationCompte.jsp";
		} else {
			...
			urlCible = "/WEB-INF/PageConnexion.jsp";
		}
