...
public class VenteDAO {
	...
	/*
	 * /!\ NEW : méthode de recherche de toutes les acquisitions de l'utilisateur avec option par
	 * mots clés du nom article et/ou noCategorie
	 */
	public static List<Vente> selectAllEncheresTermineesUtilisateur(int noUtilisateur, int noCategorie, String motsCles) {
		List<Vente> listeVentes = new ArrayList<Vente>();
		Vente vente = null;
		String[] tableauMotsCles = null;
		int nbVariablesAparametrer = 0;
