...
<body>
	...
	<form action="${pageContext.request.contextPath}/Secure/ServletProfil"
		...
		<div class="container">
			<div class="row">
				<label for="pseudo" class="col-sm-4">Pseudo : </label> <input
					type="text" name="pseudo" class="col-sm-6"
					value="${!empty pseudoValide?pseudoValide:utilisateur.pseudo}"
					required>
			</div>
			<div>${pseudoMessageErreur}</div>
			<div class="row">
				<label for="nom" class="col-sm-4">Nom : </label> <input type="text"
			...
			<div class="row">
				<label for="prenom" class="col-sm-4">Prénom :</label> <input
					type="text" name="prenom" class="col-sm-6"
			...
			<div class="row">
				<label for="email" class="col-sm-4">Email :</label> <input
					type="email" name="email" class="col-sm-6"
			...
			<div class="row">
				<label for="telephone" class="col-sm-4">Téléphone : </label> <input
					type="tel" name="telephone" class="col-sm-6"
			...
			<div class="row">
				<label for="rue" class="col-sm-4">Rue : </label> <input type="text"
					name="rue" class="col-sm-6"
					value="${!empty rueValide?rueValide:utilisateur.rue}" required>
			</div>
			<div>${rueMessageErreur}</div>
			<div class="row">
				<label for="codePostal" class="col-sm-4">Code postal : </label> <input
					type="text" name="codePostal" class="col-sm-6"
					value="${!empty codePostalValide?codePostalValide:utilisateur.codePostal}"
					required>
			</div>
			<div>${codePostalMessageErreur}</div>
			<div class="row">
				<label for="ville" class="col-sm-4">Ville : </label> <input
					type="text" name="ville" class="col-sm-6"
					value="${!empty villeValide?villeValide:utilisateur.ville}"
					required>
			</div>
			<div>${villeMessageErreur}</div>
			<div class="row">
				<label for="credit" class="col-sm-4">Crédit : </label> <span
					id="credit">${!empty credit?credit:utilisateur.credit}</span>
			</div>
			<div class="row">
				<label for="motDePasse" class="col-sm-4">Mot de passe :</label> <input
					type="password" name="motDePasse" class="col-sm-6" required
					value="${!empty motDePasseValide?motDePasseValide:utilisateur.motDePasse}">
			</div>
			<div>${motDePasseMessageErreur}</div>
			<div class="row">
				<label for="confirmation" class="col-sm-4">Confirmation :</label> <input
					type="password" name="confirmation" class="col-sm-6" required
